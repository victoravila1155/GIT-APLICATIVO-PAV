...
class FormLoginDesigner:
    ...
    def __init__(self):        
        ...
        logo =utl.leer_imagen("imagenes/logo.png", (400, 250))
        # frame_logo
        ...
        inicio = tk.Button(frame_form_fill,text="Login",font=('Times', 15,BOLD),bg='#3a7ff6', bd=0,fg="#fff",command=self.verificar)
        inicio.pack(fill=tk.X, padx=20,pady=20)        
        inicio.bind("<Return>", (lambda event: self.verificar()))

        inicio = tk.Button(frame_form_fill, text="REGISTRARSE", font=(
