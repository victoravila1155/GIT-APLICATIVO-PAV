...
class FormRegisterDesigner():
    ...
    def __init__(self):
        ...
        logo = utl.leer_imagen("imagenes/logo_registro.png", (280, 280))

        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=200,
                      relief=tk.SOLID, padx=10, pady=10, bg='#C4DCFF')
        frame_logo.pack(side="left", expand=tk.YES, fill=tk.BOTH)
        label = tk.Label(frame_logo, image=logo, bg='#C4DCFF')
        ...
        inicio = tk.Button(frame_form_fill, text="Registrar", font=(
             'Times', 15), bg='#C4DCFF', bd=0, fg="#000", command=self.register)
